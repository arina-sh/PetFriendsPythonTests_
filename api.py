...
class PetFriends:
    ...
    def update_pet_info(self, auth_key: json, pet_id: str, name: str, animal_type: str, age: str) -> json:
        ...
        try:
            ...
            result = res.text
        return status, result
    def add_pet_without_photo(self, auth_key: json, name: str, animal_type: str, age: str):
    ...
    def set_photo(self, auth_key: json, pet_id: str, pet_photo) -> json:
        """Метод отправляет на сервер данные о добавлении фото к питомцу и возвращает статус
                запроса на сервер и результат в формате JSON с данными изменённого питомца"""
